...
def quota_condition(all_shares, 
                    all_seats):
    """
...
def consistency_condition(all_var_shares=None, 
                          all_var_seats=None, 
                          check_type='seat_monotony'):
    """
    ...
    print(f"Consistency condition based on {check_type.split('_')[0]} monotony passed:", check_pass)
